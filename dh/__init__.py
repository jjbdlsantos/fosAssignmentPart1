...
def create_dh_key():
    ...
    return public, private, start


def calculate_dh_secret(their_public, my_private, start):
    ...
    print("Finished Diffie-Hellman key exchange")
    finish = time.time()
    print("Time elapsed: %s seconds" % (finish - start))
    return shared_hash
